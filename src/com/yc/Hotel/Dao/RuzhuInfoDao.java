...
public class RuzhuInfoDao {
	...
	public List<Map<String, String>> find(String cname,String rno,String orderno) {
		DBHelper db = new DBHelper();
		StringBuffer sql =new StringBuffer( "select * from check_in i where order_state=1");
	...
	public List<Map<String, String>> roomIDfind(String roomID){
		DBHelper db = new DBHelper();
		String sql="select *  from check_in where rno ='"+roomID+"'";
	...
	public  List<Map<String, String>> cnamefind(String cname) {
		DBHelper db = new DBHelper();
		String sql="select *  from check_in where cname='"+cname+"'";
		return db.finds(sql, null);
	}
	
	//查询全部	
	public  List<Map<String, String>> reservationfind() {
		DBHelper db = new DBHelper();
